...
export default function (name: string, root: string, $tag: string, properties: typeof $properties, default_mode:boolean, hide?: string[], rep?: any) {
    const tag = $tag + "$"
    ...
    for (const i of panel_properties) {
